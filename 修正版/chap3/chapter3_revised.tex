...
同様の見積もりを当研究室にあるもう一種類のコムの繰り返し周波数$1.6$ GHzにおいても行った。
      ...
      \begin{minipage}{1\hsize}
        \centering
          \includegraphics[keepaspectratio,  scale=0.6,  angle=0]
                          ...
                          \caption{$6S_{\frac{1}{2}}$から$6P_{\frac{1}{2}}$の共鳴周波数がコムの中心周波数と一致し、最近接の一光子コムの歯と$6P_{\frac{1}{2}}$の離調が$0.8$ GHzとしたときの, 二光子励起効率のパワー依存性. 図中の白い実線が$10000\ \mathrm{s^{-1}}$の励起効率を示す. コムの繰り返し周波数は$1.6$ GHz, 周波数幅は$5$ THzとした。}
